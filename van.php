...
$hong •╔═════════════════════════☩══♛══☩═════════════════════════╗• 
$blue        ☞ Zalo: 0587282880
$hong        ☞ Tel: 0567282080
$white        ☞ Facebook:facebook.com/vawnnnn  
$hong •╚═════════════════════════☩══✦══☩═════════════════════════╝•\n";
  echo "\e[1;34m┌─[\033[1;94m\e[1;32mNhấn Enter Để Bắt Đầu Tools !\n";
$wowksk=trim(fgets(STDIN));


echo"
                    \033[0;033m•╔═════☩══♛══☩═════╗•
                        \e[1;36m ĐANG ĐĂNG NHẬP \e[0m
                    \033[0;033m•╚═════☩══✦══☩═════╝•$end";
echo"\n";   
echo"\n";   

// $tenacc= "\033[1;94mBạn Đang Đăng Nhập Tự Động Với Tư Cách Là Văn";
// for($i=0;$i<strlen($tenacc);$i++){
//     echo substr( $tenacc,  0,strlen($tenacc) );
//     sleep(25000);
// }
$dem = 0;
...
//   $tokenacc = trim(fgets(STDIN));
  $tokenacc = "TDS0nI0IXZ2V2ciojIyVmdlNnIsICcpZXa2FGaiojIyV2c1Jye";
//Token 
$khoToken = [];
...
$luong=1;
for($a=1;$a<=$luong;$a++){
echo "\e[1;34m┌─[\e[1;37m\e[1;42mNhập Token Facebook Thứ $a $cyan\e[0m\e[1;34m]
└──╼ \e[1;35m>\e[1;36m>\e[1;31m> $yellowb ";
...
while(true){
  if(count($khoToken) == 0){
for($a = 1; $a < 999999;$a++){
echo "\e[1;34m┌─[\e[1;37m\e[1;42mNhập Token Facebook Thứ $a $do\e[0m\e[1;34m]
└──╼ \e[1;35m>\e[1;36m>\e[1;31m> $yellowb ";
$nhapck = (string)trim(fgets(STDIN));
if($nhapck == ''){break;}
array_push($khoToken,$nhapck);
...
$maul=rand(31,37);
$maui="\033[1;".$maul."m";
    echo "\e[1;34m┌─[";echo"\e[1;32mTools\e[0m";;echo"\e[1;31m ~ ";echo"\e[1;32mHoang Duc Van -> \e[1;36m0587282880\e[1;34m]";echo"\n";
    echo"\e[1;34m└──╼\e[1;35m>\e[1;36m>\e[1;31m> ";echo"\033[1;36m[\033[1;36m$dem\033[1;36m]\033[1;33m\033[1;32m | \e[1;36m$time\033[1;32m | \033[1;32m$maui$type\033[1;32m | \033[1;91m$id\033[1;32m | \033[1;93m$xu\033[1;35m\e[0m\n";
    $len = strlen($a);
    for ($x = 0; $x < $len; $x++) {
        echo $a[$x];
        usleep(1000);
...
function delay($delay) {
    for ($time = $delay; $time > -1; $time--) {
        echo "\r\033[1;93m   ┗van033[1;91m ~       \033[1;92m L      \033[1;91m |\033[1;93m $time\033[1;91m | ";
        usleep(150000);

        echo "\r\033[1;91m   ┗van033[0;33m   ~     \033[0;37m LO     \033[0;31m |\033[0;33m $time\033[0;31m | ";
        usleep(150000);
        echo "\r\033[1;92m   ┗van033[0;33m     ~   \033[0;37m LOA    \033[0;31m |\033[0;33m $time\033[0;31m | ";
        usleep(150000);
        echo "\r\033[1;94m   ┗van033[0;33m       ~ \033[0;37m LOAD   \033[0;31m |\033[0;33m $time\033[0;31m | ";
        usleep(150000);
        echo "\r\033[1;95m   ┗van033[0;33m        ~\033[0;37m LOAD.  \033[0;31m |\033[0;33m $time\033[0;31m | ";
        usleep(150000);
        echo "\r\033[1;95m   ┗van033[0;33m        ~\033[0;37m LOAD.. \033[0;31m |\033[0;33m $time\033[0;31m | ";
        usleep(150000);
        echo "\r\033[1;95m   ┗van033[0;33m        ~\033[0;37m LOAD...\033[0;31m |\033[0;33m $time\033[0;31m | ";
